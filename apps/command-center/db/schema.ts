...
export const vendors = sqliteTable("vendors",{id:text("id").primaryKey(),name:text("name").notNull(),businessPurpose:text("business_purpose").notNull(),status:text("status").notNull(),contractReference:text("contract_reference"),...financeControlFields});
