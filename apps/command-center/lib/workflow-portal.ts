...
export type PortalProject = {
  ...
  activities:WorkflowActivity[]; isDemonstration:boolean;
};
...
export function portalProjectFromOpportunity(input:WorkflowOpportunityInput):PortalProject {
  ...
  return {
    ...
    activities:[{
      ...
      detail:`The selected ${input.isDemonstration ? "demonstration" : "pipeline"} record was accepted into the governed lead-to-closeout workflow.`,
