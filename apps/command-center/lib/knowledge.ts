...
export const demonstrationKnowledgeData: KnowledgeData = {
  source: "demonstration", database: "connected_empty", asOf: "2026-07-20T20:00:00.000Z",
  activation: "Demonstration metadata only. Exchange files, live indexing, database writes, review assignments, and agent handoffs are not connected yet.",
  assets: [
  ...
  alerts: [
    { id:"ALT-2026-011", kind:"Broken link", severity:"Review", title:"Exchange source not connected", detail:"The historical Technical source remains a placeholder until the source file is uploaded and hashed.", assetIds:["SYM-TEC-STD-008"] },
  ...
  auditEvents: [
    ...
    { id:"KAE-2026-002", assetId:"SYM-TEC-STD-008", actorAgentId:"AGT-005", action:"Review required", reason:"Canonical Exchange source has not been uploaded", sourceEvidence:"Source availability check", correlationId:"CORR-EXCHANGE-INTAKE", previousState:"Draft", occurredAt:"2026-07-20T20:04:00Z", isDemonstration:true },
  ],
};
